    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('bread', 'bread'), ('biscuits', 'biscuits'), ('cakes', 'cakes'), ('worldwide', 'worldwide')], default='uncategorised', max_length=150, null=True)),
